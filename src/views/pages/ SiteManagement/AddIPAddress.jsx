          ...
          <div className="col-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                <h4 className="card-title">Add IP Address</h4>
                <form className="forms-sample py-3">
                  <div className="row">
                    <div className="form-group col-6">
                      <label htmlFor="">
                        Add IP Address<span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="form-group col-6">
                      ...
                      <input
                        ...
                        className="form-control"
                        id=""
                        placeholder="Add IP Address1"
                      />
                    </div>
                    <div className="form-group col-6">
                      <label htmlFor="">
                        Add IP Address2<span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control"
                        id=""
                        placeholder="Add IP Address2"
                      />
                    </div>
                    <div className="form-group col-6">
                      <label htmlFor="">
                        Add IP Address3<span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control"
                        id=""
                        placeholder="Add IP Address3"
                      />
                    </div>
                    <div className="form-group col-6">
                      <label htmlFor="">
                        Add IP Address4<span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control"
                        id=""
                        placeholder="Add IP Address4"
                      />
                    </div>
                    <div className="form-group col-6">
                      <label htmlFor="">
                        Add IP Address5<span className="text-danger">*</span>
                      </label>
                      <input
                        type="text"
                        className="form-control"
                        id=""
                        placeholder="Add IP Address5"
                      />
                    </div>
                  </div>
